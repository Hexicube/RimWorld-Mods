...
namespace RimWorld___Uncapped_Value
{
    public class UncapValMod : Mod {
        public UncapValMod(ModContentPack content) : base(content) {
        }
    }
    ...
    public class BetInfHarmonyLoader {
        static BetInfHarmonyLoader() {
            Harmony h = new Harmony("hexi.uncapval");
